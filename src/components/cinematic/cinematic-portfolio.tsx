...
export function CinematicPortfolio() {
  ...
  return <main className="cinematic-site">
    ...
    <section id="intro" className="cinematic-intro"><AmbientCanvas/><div className="intro-sequence"><p>VENKAT / INDEPENDENT PRODUCT BUILDER</p><h1><span className="intro-line"><span>BUILDING DIGITAL PRODUCTS</span></span><span className="intro-line"><span>FOR REAL BUSINESSES</span></span></h1><div className="intro-meta"><span>WEBSITES</span><span>BUSINESS SYSTEMS</span><span>CRM & POS</span></div></div><a className="scroll-signal" href="#work">ENTER THE WORK <i>↓</i></a></section>
    <div id="work" className="project-journey">{cinematicProjects.map((project) => <ProjectScene project={project} key={project.slug}/>)}</div>
    <section id="about" className="final-statement"><p>THE PRACTICE</p><h2>I BUILD DIGITAL SYSTEMS<br/>THAT SOLVE <em>REAL BUSINESS PROBLEMS.</em></h2><div><p>From websites and billing systems to CRM and field-force platforms, I design and build practical digital products for growing businesses.</p><div className="final-actions"><MagneticLink href="#work">View my work</MagneticLink><MagneticLink href="#contact" inverted>Let&apos;s work together</MagneticLink></div></div></section>
